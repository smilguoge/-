...
import managRouter from './modules/about'
import activityRouter from './modules/activity' //活动管理
/**
  ...
  adminRouter,
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '版本列表', icon: 'version', auth: true }
      },
      {
        path: 'code',
        name: 'codeList',
        component: () => import('@/views/set/codelist'),
        meta: { title: '邀请码', icon: 'codelist', auth: true }
      }
    ]
  },
